...
function Information({ duration, audience, attention, location })
{
    return (
        <div>
            ...
            <div className='flex md:flex-row  flex-col w-full' >
                ...
                <div className={`md:w-1/4 md:my-2 w-full my-2 ${!duration && 'hidden'} flex items-start`}>
                ...
                <div className={`md:w-1/4 md:my-2 w-full my-2 ${!audience && 'hidden'} flex items-start`}>
                    <div className='text-5xl mr-2 text-[#4f4cee]'>
                        <BsFillPeopleFill />
                    </div>
                    <div>
                ...
                <div className={`md:w-1/4 md:my-2 w-full my-2 ${!attention && 'hidden'} flex items-start`}>
                    <div className='text-5xl mr-2 text-[#4f4cee]'>
                        <AiFillWarning />
                    </div>
                    <div>
