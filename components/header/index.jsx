    ...
    <nav className={` bg-white border-gray-200 sm:px-4 ${padd}   rounded border-b-2  relative`}>
      <div className="container flex flex-wrap items-center justify-between mx-auto">
        <div className='ml-3 text-center'>
          <h2 className={` text-2xl text-[#4F4CEE] font-bold text-[3rem]`}>WeX</h2>
        </div>
        <div className={`w-full z-30 text-center items-center justify-between md:flex md:w-auto md:order-1 ${isMenuOpen ? "absolute top-[2.8rem] left-0" : "hidden"} `}>
          <ul className=" flex flex-col p-4 mt-4 border border-gray-100 rounded-b-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white ">
            <li>
